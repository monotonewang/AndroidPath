...
public class LeftMenuAdapter extends RecyclerView.Adapter {
    ...
    public interface onItemSelectedListener{
        void onLeftItemSelected(int postion, DishMenu menu);
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.shopcart_left_menu_item, parent, false);
