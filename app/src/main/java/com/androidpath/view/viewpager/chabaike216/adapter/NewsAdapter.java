package com.androidpath.view.viewpager.chabaike216.adapter;
...
import com.androidpath.view.viewpager.chabaike216.custem.CacheImageView;
...
public class NewsAdapter extends BaseAdapter {
	...
	/**
	 * ViewHolder的作用：用来缓存布局中的控件，避免下一个findViewById
	 * @author Ken
	 *
	 */
	class ViewHolder{
