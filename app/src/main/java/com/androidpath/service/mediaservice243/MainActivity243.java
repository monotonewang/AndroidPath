package com.androidpath.service.mediaservice243;
...
import com.androidpath.service.mediaservice243.modle.MusicEntity;
import com.androidpath.service.mediaservice243.service.MediaService;
import com.androidpath.service.mediaservice243.util.Constants;

import java.util.ArrayList;

public class MainActivity243 extends Activity implements OnItemClickListener {
    ...
    protected void onStart() {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(MainActivity243.this, new String[]{Manifest.permission.CALL_PHONE}, readSDCard);
        } else {
            initView();
            initLoader();
        }
    ...
    private void initLoader() {
        getLoaderManager().initLoader(1, null, new LoaderCallbacks<Cursor>() {
            ...
            public Loader<Cursor> onCreateLoader(int id, Bundle args) {
                return new CursorLoader(MainActivity243.this, map3Uri, colums, null, null, null);
            }
