package com.androidpath.async.progresslow73;
 ...
 * */
public class MyAsyncTask73 extends AsyncTask<String, Integer, Bitmap> {
	...
	public MyAsyncTask73(Context context, ImageView imageView) {
	...
	protected void onPreExecute() {
		...
		super.onPreExecute();
		// Toast.makeText(MainActivity73.this, "onPreExecute", 0).show();
		Log.e("MyAsyncTask73", "onPreExecute");
...
//				Log.d("curretProgress", curretProgress+"==========");
		...
		// Toast.makeText(MainActivity73.this, "doInBackground"+urlString,
		// 0).show();
		Log.e("MyAsyncTask73", "doInBackground");
	...
	protected void onProgressUpdate(Integer... values) {
		// TODO Auto-generated method stub
		// Toast.makeText(MainActivity73.this, "onProgressUpdate", 0).show();
		super.onProgressUpdate(values);
//		Log.e("MyAsyncTask73", "onProgressUpdate:"+values[0]);
	...
	protected void onPostExecute(Bitmap result) {
		// TODO Auto-generated method stub
		// Toast.makeText(MainActivity73.this, "onPostExecute", 0).show();
		Log.e("MyAsyncTask73", "onPostExecute");
		// 停止进度显示
		dialog.dismiss();
