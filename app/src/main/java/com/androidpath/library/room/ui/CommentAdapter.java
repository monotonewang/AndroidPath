...
import com.androidpath.databinding.RoomCommentItemBinding;
...
public class CommentAdapter extends ListAdapter<CommentEntity, CommentAdapter.CommentViewHolder> {
    ...
    public CommentViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        RoomCommentItemBinding binding = DataBindingUtil
                .inflate(LayoutInflater.from(parent.getContext()), R.layout.room_comment_item,
                        parent, false);
    ...
    static class CommentViewHolder extends RecyclerView.ViewHolder {
        ...
        final RoomCommentItemBinding binding;

        CommentViewHolder(RoomCommentItemBinding binding) {
