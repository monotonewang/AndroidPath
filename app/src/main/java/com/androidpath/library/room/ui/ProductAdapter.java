...
import com.androidpath.databinding.RoomProductItemBinding;
...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ProductViewHolder> {
    ...
    public ProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        RoomProductItemBinding binding = DataBindingUtil
                .inflate(LayoutInflater.from(parent.getContext()), R.layout.room_product_item,
                        parent, false);
    ...
    static class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        final RoomProductItemBinding binding;

        public ProductViewHolder(RoomProductItemBinding binding) {
