...
import com.androidpath.databinding.RoomListFragmentBinding;
import com.androidpath.library.room.BasicRoomActivity;
import com.androidpath.library.room.entity.ProductEntity;
import com.androidpath.library.room.viewmodel.ProductListViewModel;
...
public class ProductListFragment extends Fragment {
    ...
    private final ProductClickCallback mProductClickCallback = product -> {
        if (getLifecycle().getCurrentState().isAtLeast(Lifecycle.State.STARTED)) {
            ((BasicRoomActivity) requireActivity()).show(product);
        }
    };
}
