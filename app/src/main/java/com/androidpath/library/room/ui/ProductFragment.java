...
package com.androidpath.library.room.ui;
...
import com.androidpath.databinding.RoomProductFragmentBinding;
import com.androidpath.library.room.viewmodel.ProductViewModel;
...
public class ProductFragment extends Fragment {
    ...
    private RoomProductFragmentBinding mBinding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        mBinding = DataBindingUtil.inflate(inflater, R.layout.room_product_fragment, container, false);
    ...
    private final CommentClickCallback mCommentClickCallback = comment -> {
        // no-op
        Toast.makeText(getContext(),comment.getText(),Toast.LENGTH_LONG).show();
    };
