package com.androidpath.activity.aiviewpager.cbk.chabaike216.custem;
...
import com.androidpath.activity.aiviewpager.cbk.chabaike216.util.ImageUtil;
...
public class CacheImageView extends ImageView implements DownUtil.OnDownComplete {
	...
	public void setUrl(String url){
		this.setTag(url);
		this.setImageResource(R.drawable.list_default_image);
		//从内存和磁盘中寻找
