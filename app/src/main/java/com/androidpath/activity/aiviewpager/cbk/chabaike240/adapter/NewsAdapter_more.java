...
import com.androidpath.activity.aiviewpager.cbk.chabaike240.custem.CacheImageView;
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if(arg1 != null){
			...
			if(getItemViewType(arg0) == 0){
				arg1 = LayoutInflater.from(context).inflate(R.layout.item_news240, null);
				...
				arg1 = LayoutInflater.from(context).inflate(R.layout.item_newsmore240, null);
